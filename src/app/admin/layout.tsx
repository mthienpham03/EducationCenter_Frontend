        ...
        <aside className="w-full border-b border-[#bbe7ff] bg-white p-5 lg:w-72 lg:border-r lg:border-b-0">
          ...
          <nav className="space-y-2 text-sm text-slate-700">
            ...
            <div className="pt-4 pb-1">
              <p className="px-4 text-xs font-semibold uppercase tracking-wider text-slate-500">Thống kê & Báo cáo</p>
            </div>
            <a href="/admin/reports/progress" className="block rounded-2xl px-4 py-3 text-slate-700 transition hover:bg-[#d6f1ff]">
              Báo cáo tiến độ
            </a>
            <a href="/admin/reports/quiz-results" className="block rounded-2xl px-4 py-3 text-slate-700 transition hover:bg-[#d6f1ff]">
              Báo cáo điểm thi
            </a>
            <div className="pt-4 pb-1">
              <p className="px-4 text-xs font-semibold uppercase tracking-wider text-slate-500">Hệ thống</p>
            </div>
