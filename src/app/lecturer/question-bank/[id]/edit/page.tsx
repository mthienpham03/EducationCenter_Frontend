  ...
  if (!question) {
    return (
      <div className="text-center py-10">
        ...
        <Link href="/lecturer/question-bank" className="text-primary ml-2 hover:underline">Quay lại</Link>
      </div>
    );
  }
  ...
  return (
    <div className="p-stack-md max-w-container-max mx-auto space-y-stack-md">
      <div className="flex flex-col gap-2 mb-stack-lg">
        <Link href="/lecturer/question-bank" className="text-primary hover:underline flex items-center gap-1 w-fit font-label-md">
